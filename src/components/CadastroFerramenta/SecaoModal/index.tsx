    ...
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      ...
      >
        <View style={styles.cabecalho}>
          ...
          <TouchableOpacity style={styles.botaoFechar} onPress={onClose} accessibilityLabel="Fechar seção">
        ...
        <View style={styles.rodape}>
          <TouchableOpacity style={styles.botaoConcluir} onPress={onClose} activeOpacity={0.85}>
